...
Full_Physiology1<-read.table("Visual_bleaching_assesment_T1.txt",  sep = "\t", header = T) 
...
visual_bleaching1<-lmer(Median ~ Temp*System + (1|Replicates/System), data = Sty_phys1)
...
Full_Physiology2<-read.table("Visual_bleaching_assesment_T2.txt",  sep = "\t", header = T) 
#Full_Physiology <-read.csv("Visual_bleaching_assesment-Luigi_T1")
...
visual_bleaching_final2<-lmer(Median ~ Temp*System + (1|Replicates/System), data = Sty_phys2)
